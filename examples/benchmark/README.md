...
$ papermill tfmodel_train_scratch.ipynb output/tfmodel_train_scratch-wikitext_103_raw-post_ln-lr_e4.ipynb -p model_type post_ln -p save_model_dir tfchat_model-post_ln-lr_e4
...
| TfChat.PostLNDecoder | GELU | Yes | 1731 | [output/tfmodel_train_scratch-wikitext_103_raw-post_ln-lr_e4.ipynb](output/tfmodel_train_scratch-wikitext_103_raw-post_ln-lr_e4.ipynb) |
...
| TfChat.PreLNDecoder | GELU | Yes | None | Off | 2 | 19.98 | 24472s | [output/tfmodel_train_scratch-wikitext_103_raw-pre_ln-gelu-lr_e4-clipnorm_none.ipynb](output/tfmodel_train_scratch-wikitext_103_raw-pre_ln-gelu-lr_e4-clipnorm_none.ipynb) |
| TfChat.PreLNDecoder | GELU | Yes | None | On  | 2 | 20.09 | 16398s | [output/tfmodel_train_scratch-wikitext_103_raw-pre_ln-gelu-lr_e4-clipnorm_none-fp16.ipynb](output/tfmodel_train_scratch-wikitext_103_raw-pre_ln-gelu-lr_e4-clipnorm_none-fp16.ipynb) |
| TfChat.PreLNDecoder | GELU | Yes | None | On  | 4 | 20.35 | 13045s | [output/tfmodel_train_scratch-wikitext_103_raw-pre_ln-gelu-lr_e4-clipnorm_none-fp16-batch_size_4.ipynb](output/tfmodel_train_scratch-wikitext_103_raw-pre_ln-gelu-lr_e4-clipnorm_none-fp16-batch_size_4.ipynb) |
